...
# Remove source and leave compiled libs
RUN find /opt/mlc-llm/ -maxdepth 1 -mindepth 1 ! -name build -exec rm -rf {} \;
...
# Copy vicunaserver, mlc-llm libs, compiled model, and whl files for pip install
